  ...
  return (
    <>
      <motion.div
        ref={leafletRef}
        key="leaflet"
        className="group fixed inset-x-0 bottom-0 z-40 -mb-20 w-screen cursor-grab rounded-t-[30px] bg-white/60 pb-20 shadow-xl backdrop-blur backdrop-brightness-125 active:cursor-grabbing md:hidden"
        initial={{ y: "100%" }}
        animate={controls}
        exit={{ y: "100%" }}
